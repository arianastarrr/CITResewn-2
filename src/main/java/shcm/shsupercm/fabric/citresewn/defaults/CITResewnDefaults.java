...
import shcm.shsupercm.fabric.citresewn.defaults.cit.builtin.types.TypeArmor;
import shcm.shsupercm.fabric.citresewn.defaults.cit.builtin.types.TypeElytra;
 ...
 */
public abstract class CITResewnDefaults implements ClientModInitializer {
    /**
    ...
    public static void initAll() {
        for (EntrypointContainer<CITResewnDefaults> compat : FabricLoader.getInstance().getEntrypointContainers(CITResewnDefaults.ENTRYPOINT, CITResewnDefaults.class))
