...
public class NBTCondition extends CITCondition {
    /*? <1.21 {*//*@Entrypoint(CITConditionContainer.ENTRYPOINT)*//*?}*/
    public static final CITConditionContainer<NBTCondition> CONTAINER = new CITConditionContainer<>(NBTCondition.class, NBTCondition::new,
            "nbt");
