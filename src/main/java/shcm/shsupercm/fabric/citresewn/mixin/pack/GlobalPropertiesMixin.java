 ...
 * @see PackParserMixin#loadGlobalProperties(ResourceManager, GlobalProperties)
 */
public class GlobalPropertiesMixin extends PropertyGroup {
    public GlobalPropertiesMixin() {
