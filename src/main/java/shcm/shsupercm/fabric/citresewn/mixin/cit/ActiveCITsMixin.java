...
import shcm.shsupercm.fabric.citresewn.mixin.pack.GlobalPropertiesMixin;
 ...
 */
public class ActiveCITsMixin { private ActiveCITsMixin() {}
	/**
	 * @see #load(ResourceManager, Profiler)
	 * @see #getActive()
	 * @see #isActive()
	 */
    private static ActiveCITsMixin active = null;

	/**
	 * @see #isActive()
	 * @return the current active CITs manager or null if none are loaded
	 */
    public static ActiveCITsMixin getActive() {
        return active;
    }
	 ...
	 */
    public final GlobalPropertiesMixin globalProperties = new GlobalPropertiesMixin();
	 ...
	 * @see ModelLoaderMixin
	 * @see PackParserMixin#loadGlobalProperties(ResourceManager, GlobalPropertiesMixin)
	 * @see GlobalPropertiesMixin#callHandlers()
	 * @see PackParserMixin#parseCITs(ResourceManager)
    ...
    public static void load(ResourceManager resourceManager, Profiler profiler) {
        ...
        ActiveCITsMixin active = new ActiveCITsMixin();

        profiler.swap("citresewn:load_global_properties");
        PackParserMixin.loadGlobalProperties(resourceManager, active.globalProperties).callHandlers();

        profiler.swap("citresewn:load_cits");
        List<CIT<?>> cits = PackParserMixin.parseCITs(resourceManager);
