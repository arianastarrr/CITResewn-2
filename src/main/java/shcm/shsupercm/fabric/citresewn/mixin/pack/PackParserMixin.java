package shcm.shsupercm.fabric.citresewn.mixin.pack;
 ...
 */
public final class PackParserMixin { private PackParserMixin() {}
    /**
     ...
     */
    public static GlobalPropertiesMixin loadGlobalProperties(ResourceManager resourceManager, GlobalPropertiesMixin globalProperties) {
